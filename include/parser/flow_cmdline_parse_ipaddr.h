...
extern struct cmdline_token_ops tyflow_cmdline_token_ipaddr_ops;

int tyflow_cmdline_parse_ipaddr(cmdline_parse_token_hdr_t *tk, const char *srcbuf,
	void *res, unsigned ressize);
int tyflow_cmdline_get_help_ipaddr(cmdline_parse_token_hdr_t *tk, char *dstbuf,
	unsigned int size);
...
{                                                       \
	/* hdr */                                           \
	{                                                   \
		&tyflow_cmdline_token_ipaddr_ops,      /* ops */       \
