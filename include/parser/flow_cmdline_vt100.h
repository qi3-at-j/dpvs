...
extern const char *tyflow_cmdline_vt100_commands[];
 ...
 * Init
 */
extern void tyflow_vt100_init(struct cmdline_vt100 *vt);
 ...
 */
int tyflow_vt100_parser(struct cmdline_vt100 *vt, char c);
