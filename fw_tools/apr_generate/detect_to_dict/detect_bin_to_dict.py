...
def gen_ruleopt_info_proc(json_detect_info,id_r,tlv_len,tlv_v_s):
    ...
    while True:
        ...
        if cur_tlv_t == 99:
            ...
            json_detect_info[id_r]['app_id'] = get_value(cur_tlv_v)
        elif cur_tlv_t == 112:
            # flowbits
            # print('flowbits t {} l {} v:[{}] in ruleopt {}'.format(cur_tlv_t, ruleopt_tlv_len, cur_tlv_v, id_r))
            pass
        else:
            print('unrecognized t {} l {} v:[{}] in ruleopt {}'.format(cur_tlv_t, ruleopt_tlv_len, cur_tlv_v, id_r))
            pass
...
def sig_ac_proc(sig_ac_info,sig_tlv_len,sig_ac_v):
    ...
    while True:
        ...
        if ac_tlv_t == 164:
            ...
            print('unrecognized type in ac:{}'.format(ac_tlv_t))
            pass
...
def sig_option_proc(sig_opt_info,sig_tlv_t,sig_tlv_len,sig_opt_v):
    ...
    while True:
        ...
        if opt_tlv_t == 164 or opt_tlv_t == 16:
            ...
            print('unrecognized type in option:{}'.format(opt_tlv_t))
            pass
