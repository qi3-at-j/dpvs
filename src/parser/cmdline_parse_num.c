...
struct cmdline_token_ops tyflow_cmdline_token_num_ops = {
	.parse = tyflow_cmdline_parse_num,
	.complete_get_nb = NULL,
	.complete_get_elt = NULL,
	.get_help = tyflow_cmdline_get_help_num,
};
...
/* parse an int */
int
tyflow_cmdline_parse_num(cmdline_parse_token_hdr_t *tk, const char *srcbuf, void *res,
	unsigned ressize)
{
	...
	while ( st != ERROR && c && ! tyflow_cmdline_isendoftoken(c) ) {
...
/* parse an int */
int
tyflow_cmdline_get_help_num(cmdline_parse_token_hdr_t *tk, char *dstbuf, unsigned int size)
{
	struct cmdline_token_num_data nd;
	int ret;
