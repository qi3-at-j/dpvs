...
struct cmdline_token_ops tyflow_cmdline_token_string_ops = {
	.parse = NULL,
	.complete_get_nb = tyflow_cmdline_complete_get_nb_string,
	.complete_get_elt = tyflow_cmdline_complete_get_elt_string,
	.get_help = tyflow_cmdline_get_help_string,
};
...
int
tyflow_cmdline_parse_string(cmd_node_t *node, const char *buf, cmd_blk_t *cmd_blk)
{
    return 0;
#if 0
