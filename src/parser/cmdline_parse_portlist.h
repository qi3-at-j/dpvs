...
extern struct cmdline_token_ops tyflow_cmdline_token_portlist_ops;

int tyflow_cmdline_parse_portlist(cmdline_parse_token_hdr_t *tk,
	const char *srcbuf, void *res, unsigned ressize);
int tyflow_cmdline_get_help_portlist(cmdline_parse_token_hdr_t *tk,
...
{                                                           \
	/* hdr */                                               \
	{                                                       \
		&tyflow_cmdline_token_portlist_ops,    /* ops */           \
