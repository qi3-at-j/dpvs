...
struct cmdline_token_ops tyflow_cmdline_token_etheraddr_ops = {
	...
	.get_help = tyflow_cmdline_get_help_etheraddr,
};
...
int
tyflow_cmdline_parse_etheraddr(__attribute__((unused)) cmdline_parse_token_hdr_t *tk,
	const char *buf, void *res, unsigned ressize)
{
	...
	while (!tyflow_cmdline_isendoftoken(buf[token_len]))
		token_len++;
...
int
tyflow_cmdline_get_help_etheraddr(__attribute__((unused)) cmdline_parse_token_hdr_t *tk,
