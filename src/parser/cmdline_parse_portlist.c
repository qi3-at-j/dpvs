...
struct cmdline_token_ops tyflow_cmdline_token_portlist_ops = {
	...
	.get_help = tyflow_cmdline_get_help_portlist,
};
...
int
tyflow_cmdline_parse_portlist(__attribute__((unused)) cmdline_parse_token_hdr_t *tk,
...
int
tyflow_cmdline_get_help_portlist(__attribute__((unused)) cmdline_parse_token_hdr_t *tk,
